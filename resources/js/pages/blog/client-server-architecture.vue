...
<template>
    ...
    >
        ...
        <p>
            ...
            <em>literally</em> serves you food. In a similar sense, a computer server
            <em>literally</em> serves you data.
        </p>
        <p>
        ...
        <p>
            ...
            server, it processes your request, finds the right video, and
            sends it back to your browser, the client, to be played.
        </p>
        <Heading title="More Practical Programming Examples" />
        <p>
            This pattern is very convenient because it matches our <em>HTTP Request
            Lifecycle</em> model very well. A client will send an HTTP request
        ...
        <p>
            In the code itself, it may be structured like a client and
            server instead, where the client is the GUI that accepts user
        ...
        <Callout type="tip" title="Why do it this way?">
            <p>
                ...
                like overkill, however, this demonstrates the pattern very well. In a
        ...
        <p>
            ...
            whatever we want! As long as the client can send a <em>request</em>, or
            talk to the server, we can use <strong>any</strong> client without having

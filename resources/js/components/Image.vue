...
<template>
    <div :class="[
        'rounded-lg border border-orange-500/40 bg-slate-800/80 p-2 shadow-lg backdrop-blur-sm',
        alignmentClasses[align],
    ]" :style="{ width, height }">
        <img :src="src" :alt="alt" :width="naturalWidth" :height="naturalHeight" loading="lazy"
